...
import { existsSync, linkSync, mkdirSync, readFileSync } from "fs";
import { Validator } from "jsonschema";
import path from "path";
import yaml from "yaml";
import {
    FORMS_CONFIG_PATH,
    FORMS_JSON_SCHEMA_PATH,
    FRONTEND_PUBLIC_PATH,
    HOME_CONFIG_PATH,
    HOME_JSON_SCHEMA_PATH,
    IMAGE_NAMES,
    IMAGES_DIR,
    TEST_CONFIG_PATH,
    TEST_JSON_SCHEMA_PATH,
    TRANSLATIONS_CONFIG_PATH,
    TRANSLATIONS_JSON_SCHEMA_PATH,
} from "./constants";
import {
    FlatRawConfig,
    FlatRawGroup,
 ...
 */
export function parseConfig(): FlatRawConfig {
    ...
    return validateConfig(flatConfig);
}
