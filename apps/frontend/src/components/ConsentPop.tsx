...
interface ConsentPopProps {
    ...
    onAccept: () => void; // Función para aceptar los términos
    onReject: () => void; // Función para rechazar los términos
}

const ConsentPop: React.FC<ConsentPopProps> = ({ onClose, onAccept, onReject }) => {
    return (
